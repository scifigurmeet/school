	...
	<div class="user-data m-b-30 threeD">
			...
			<div class="row">
				<div class="col" style="padding: 0px 50px 30px 50px;">
					<span class="label">Enter Student ID</span><br>
					<input type="number" id="student_id" class="form-control" style="width:200px;"><br>
					<button class="btn btn-success" onclick="getAllDueFees($('#student_id').val());">View Due Fee(s)</button>
				</div>
			</div>
			<div class="row">
				<div class="col" style="padding: 0px 50px 30px 50px;">
